...
public class Render2d {
    ...
    public static void drawGradientRectHorizontalActiveGui(Rectangle rectangle) {
        double zLevel = 0.0;

        Color startColor = GuiUtil.activeColor;
        Color endColor = GuiUtil.secondActiveColor;
    ...
    public static void drawGradientRectHorizontal(Rectangle rectangle) {
        double zLevel = 0.0;

        Color startColor = GuiUtil.baseColor;
        Color endColor = GuiUtil.secondBaseColor;
