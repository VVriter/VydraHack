...
public abstract class Shader {
    ...
    public Shader(final String fragmentShader) {
        ...
        try (final InputStream vertexStream = getClass().getResourceAsStream("/assets/vertex.vert")) {
            System.out.println("Stram: " + vertexStream.toString());
        ...
        try (final InputStream fragmentStream = getClass().getResourceAsStream("/assets/frag/" + fragmentShader)) {
            System.out.println("Stram: " + fragmentStream.toString());
